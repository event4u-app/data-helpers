...
|----------------|------------|----------|---------------|
| LiteDto | 3.669μs | 6.542μs | 3.683μs |
| LiteDto #[UltraFast] | 2.323μs | 4.354μs | 2.343μs |
| SimpleDto #[UltraFast] | 4.674μs | 30.065μs | 4.643μs |
...
|---------|---------|----------------------|------------------|------------------------|
| Performance | ~4.6μs | ~3.0μs | ~14.4μs | ~13.1μs |
| Validation | ✅ | ✅ | ✅ | ❌ |
| Type Casting | ✅ | ✅ | ✅ | ❌ |
| Property Mapping | ✅ | ✅ | ✅ | ✅ |
| Nested DTOs | ✅ | ✅ | ✅ | ✅ |
