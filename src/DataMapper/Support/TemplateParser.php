...
use event4u\DataHelpers\DataMapper\Support\TemplateCompilationCache;
...
final class TemplateParser
{
     ...
     *
     * Phase 3 Enhancement: Uses TemplateCompilationCache for better performance.
     *
    ...
    {
        return TemplateCompilationCache::isTemplate($value);
    }
    ...
    {
        return TemplateCompilationCache::extractPath($template);
    }
    ...
    {
        return TemplateCompilationCache::tryExtractTemplate($template);
    }
     ...
     * @return array<string, string|non-empty-array<string, mixed>> Parsed mapping
     */
    public static function parseMapping(array $mapping, string $staticMarker = '__static__'): array
    {
        return TemplateCompilationCache::compileMapping($mapping, $staticMarker);
    }
