...
main() {
    ...
    # Update getting started introduction (comparison section)
    if [ -f "starlight/src/content/docs/getting-started/introduction.md" ]; then
        perl -i -pe "s/- \*\*Well-tested\*\* - \d+\+?\s+tests with PHPStan Level 9 compliance/- **Well-tested** - ${tests_rounded}+ tests with PHPStan Level 9 compliance/g" starlight/src/content/docs/getting-started/introduction.md
        print_success "Updated starlight/src/content/docs/getting-started/introduction.md"
    fi
}
