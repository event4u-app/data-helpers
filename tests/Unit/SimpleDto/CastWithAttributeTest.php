...
// Test DTOs
class SimpleDtoCastWithUserDto extends SimpleDto
{
...
class SimpleDtoCastWithEventDto extends SimpleDto
{
    public function __construct(
...
class SimpleDtoCastWithCustomDto extends SimpleDto
{
    /** @param array<mixed> $metadata */
    public function __construct(
        #[CastWith(SimpleDtoUpperCaseCaster::class)]
        public readonly string $name,
        #[CastWith(SimpleDtoJsonCaster::class)]
