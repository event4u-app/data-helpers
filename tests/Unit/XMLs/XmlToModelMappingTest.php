        ...
        it('maps complete project with all relations from version3 XML', function(): void {
            ...
            $mapping = [
                'project' => [
                    ...
                    'title' => '{{ lvdata.lv_description }}',
                    'description' => '{{ lvdata.project_description }}',
                ...
                'customer' => [
                    'name1' => '{{ lvdata.customer_name }}',
                    'name2' => '{{ lvdata.customer_name2 }}',
                    'name3' => '{{ lvdata.customer_name3 }}',
                    'street' => '{{ lvdata.customer_address }}',
                    'zipcode' => '{{ lvdata.customer_zipcode }}',
                    'city' => '{{ lvdata.customer_city }}',
                ],
                'positions' => [
                    '*' => [
                        'number' => '{{ lvdata.posdata.*.pos_number }}',
                        'parent_id' => '{{ lvdata.posdata.*.parent_id }}',
                        'short_text' => '{{ lvdata.posdata.*.pos_text }}',
                        'long_text' => '{{ lvdata.posdata.*.pos_long_text | trim }}',
                        'quantity' => '{{ lvdata.posdata.*.pos_quantity ?? 0.0 }}',
                        'unit' => '{{ lvdata.posdata.*.pos_unit }}',
                        ...
                        'address' => '{{ lvdata.posdata.*.pos_address }}',
                        'zipcode' => '{{ lvdata.posdata.*.pos_zipcode }}',
                        'city' => '{{ lvdata.posdata.*.pos_city }}',
