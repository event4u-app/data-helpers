...
describe('NullCacheAdapter', function () {
    ...
    it('always returns false on delete', function () {
        expect($this->cache->delete('key'))->toBeFalse();
    });

    it('always returns true on clear', function () {
