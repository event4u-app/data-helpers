...
describe('FilterEngine Filter Caching', function(): void {
    it('caches filter instances', function(): void {
    ...
    it('reuses filter instances for same filter', function(): void {
        // Use reflection to check if instances are reused
        $reflection = new ReflectionClass(FilterEngine::class);
        $property = $reflection->getProperty('filterInstances');
    ...
    it('creates separate instances for different filters', function(): void {
        $reflection = new ReflectionClass(FilterEngine::class);
        $property = $reflection->getProperty('filterInstances');
        ...
        // Should have 3 different filter instances
    ...
    it('does not mix up results for different filters', function(): void {
