...
describe('TypeScriptGenerator', function(): void {
    it('generates basic interface', function(): void {
        ...
        $typescript = $generator->generate([get_class($dto)]);
    ...
    it('handles nested DTOs', function(): void {
        ...
        $generator = new TypeScriptGenerator();
        $typescript = $generator->generate([get_class($userDto)]);
    ...
    it('supports different export types', function(): void {
        ...
        // Export
        $typescript = $generator->generate([get_class($dto)], ['exportType' => 'export']);
        expect($typescript)->toContain('export interface');

        // Declare
        $typescript = $generator->generate([get_class($dto)], ['exportType' => 'declare']);
        expect($typescript)->toContain('declare interface');

        // No export
        $typescript = $generator->generate([get_class($dto)], ['exportType' => '']);
        expect($typescript)->toContain(' interface');
    ...
    it('supports includeComments option', function(): void {
        ...
        // With comments
        $typescript = $generator->generate([get_class($dto)], ['includeComments' => true]);
        expect($typescript)->toContain('/**');
        expect($typescript)->toContain('Generated from:');

        // Without comments
        $typescript = $generator->generate([get_class($dto)], ['includeComments' => false]);
    ...
    it('handles multiple DTOs', function(): void {
        ...
        $generator = new TypeScriptGenerator();
        $typescript = $generator->generate([get_class($dto1), get_class($dto2)]);
