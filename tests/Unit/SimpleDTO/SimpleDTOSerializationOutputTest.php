...
describe('SimpleDTOSerializationOutputTest', function (): void {
    ...
    describe('toJson()', function (): void {
        it('converts DTO to JSON string', function () {
        ...
        it('supports JSON_PRETTY_PRINT flag', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John Doe',
                'email' => 'john@example.com',
                'age' => 30,
        ...
        it('supports JSON_UNESCAPED_UNICODE flag', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'Müller',
    ...
    describe('toXml()', function (): void {
        it('converts DTO to XML string', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John Doe',
                'email' => 'john@example.com',
                'age' => 30,
        ...
        it('uses class name as default root element', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John Doe',
                'email' => 'john@example.com',
                'age' => 30,
            ...
            expect($xml)->toContain('<testserialization>');
            expect($xml)->toContain('</testserialization>');
        });

        it('supports custom root element', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John Doe',
                'email' => 'john@example.com',
                'age' => 30,
        ...
        it('escapes special XML characters', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John & Jane <Doe>',
                'email' => 'john@example.com',
                'age' => 30,
    ...
    describe('toYaml()', function (): void {
        it('converts DTO to YAML string', function () {
            if (!function_exists('yaml_emit') && !class_exists(\Symfony\Component\Yaml\Yaml::class)) {
        ...
        it('throws exception when YAML support not available', function () {
            if (function_exists('yaml_emit') || class_exists(\Symfony\Component\Yaml\Yaml::class)) {
    ...
    describe('toCsv()', function (): void {
        it('converts DTO to CSV string with headers', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John Doe',
                'email' => 'john@example.com',
                'age' => 30,
        ...
        it('quotes values with commas', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'Doe, John',
                'email' => 'john@example.com',
                'age' => 30,
        ...
        it('quotes values with quotes', function () {
            $dto = ($this->dtoClass)::fromArray([
                'name' => 'John "The Boss" Doe',
                'email' => 'john@example.com',
                'age' => 30,
